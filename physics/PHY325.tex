...
This is a modified midpoint method. 

\[H = Nh\]

where $N$ is an even integer and $H$ is constant. We try different values of $N$ until we have some confidence of what the next value should be and then extrapolate to $n \to \infty$.
